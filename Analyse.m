...
plot(pos(:,1),pos(:,2),'color',[0.813725 0.313725 0.313725],'lineStyle',' -');
plot(pos(:,3),pos(:,4),'color',[0.774510 0.774510 0.343137],'lineStyle',' -');
plot(pos(:,5),pos(:,6),'color',[0.696078 0.696078 0.696078],'lineStyle',' -');
axis ij
